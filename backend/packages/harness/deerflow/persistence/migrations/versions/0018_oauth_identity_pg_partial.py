...
Revises: 0018_merge_inventory_pat
...
convention, so this revision moved to 0018 and re-parented onto it. During
the public-branch merge it re-parented again onto ``0018_merge_inventory_pat``
so the shared tree keeps a single head after the merge.
"""
...
down_revision: str | Sequence[str] | None = "0018_merge_inventory_pat"
