...
export default function AvatarDock() {
  ...
  // Click-triggered poses (摆姿势/比耶/转圈) play a single time and then
  // return to the resting standing pose; idle and speaking motions keep
  // looping as before.
  const loopAnimation = clickIndex === null;
    ...
    <>
      ...
      <div
        className={`fixed z-40 flex flex-col overflow-visible ${
          dock.collapsed ? "pointer-events-none invisible" : ""
        }`}
        style={{
          right: dock.right,
          bottom: dock.bottom,
      ...
      >
        ...
        <div
          ...
          style={{
            WebkitMaskImage:
              "radial-gradient(ellipse 88% 92% at center, #000 58%, rgb(0 0 0 / 0.96) 74%, rgb(0 0 0 / 0.78) 88%, transparent 100%)",
            maskImage:
              "radial-gradient(ellipse 88% 92% at center, #000 58%, rgb(0 0 0 / 0.96) 74%, rgb(0 0 0 / 0.78) 88%, transparent 100%)",
          }}
        >
