...
class TestModeGating:
    ...
    def test_lead_agent_deduplicates_memory_tools_after_appending(self, monkeypatch):
        ...
        monkeypatch.setattr(
            lead_agent_module,
            "load_agent_config",
            lambda name, *, user_id=None: SimpleNamespace(model=None, skills=None, tool_groups=None, mcp_servers=None, memory_enabled=True, allowed_subagents=None, thinking_enabled=None, reasoning_effort=None),
        )
