...
_CANONICAL_0019_SCHEMA_FLOOR: dict[str, frozenset[str]] = {
    ...
    "operation_events": frozenset("actor_kind created_at event_metadata event_type id source user_id".split()),
    "operation_inventory_snapshots": frozenset("captured_at id total_agents total_artifacts total_skills".split()),
